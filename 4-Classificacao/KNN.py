...
def main():
    ...
    features = ['Dia','Mes','Ano','Temperatura','RH','WS','Chuva','FFMC','DMC','DC','ISI','BUI','FWI']
    ...
    plot_confusion_matrix(cm, ['Sem Incêndio', 'Incêndio'], False,
                          "Confusion Matrix - K-NN")
    plot_confusion_matrix(cm, ['Sem Incêndio', 'Incêndio'], True,
