...
def main():
    ...
    features = ['Dia','Mes','Ano','Temperatura','RH','WS','Chuva','FFMC','DMC','DC','ISI','BUI','FWI','Classes']
    output_file = '../1-DataSets/regiao1_limpo_mean.data'
    input_file = '../1-DataSets/regiao1_missing_values.data'
